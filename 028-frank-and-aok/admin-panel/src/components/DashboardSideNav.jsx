...
function DashboardSideNav() {
  ...
  const handleLogOut = ()=>{
    Cookies.remove('admin_1283');
    Navigate('/');
  };

  return (
    <div className={navVisible === false ? "w-full bg-[#141415] min-h-[100vh]" : "hidden w-0"}>

      <Link to={"/dashboard"}>
        <div className="p-[16px] uppercase text-center text-white text-[24px] border-bottom cursor-pointer">
          Frank and Oak
        </div>
      </Link>
      ...
      <ul className="list-none w-auto m-[8px] text-[16px] text-white sideNav">
        ...
        <Link to={"/dashboard"}>
          <li className="w-full grid grid-cols-[20%_auto] px-[12px] text-white py-[10px] rounded-[5px] bg-[#515151] cursor-pointer mb-[5px] box-border">
            <span className="icon">
        ...
        <Link to={"/dashboard/profile"}>
          <li className="w-full grid grid-cols-[20%_auto] px-[12px] py-[10px] rounded-[5px] hover:text-white hover:bg-[#515151]  cursor-pointer mb-[5px] box-border">
            <span className="icon">
        ...
        <li className="w-full grid grid-cols-[20%_auto_10%] px-[12px] py-[10px] rounded-[5px] hover:bg-[#515151]  cursor-pointer mb-[5px] box-border" onClick={() => setColor(!color)}>
          <span className="icon">
        ...
        <li className="w-full grid grid-cols-[20%_auto_10%] px-[12px] py-[10px] rounded-[5px] hover:bg-[#515151]  cursor-pointer mb-[5px] box-border" onClick={() => setCategory(!category)}>
          <span className="icon">
        ...
        <li className="w-full grid grid-cols-[20%_auto_10%] px-[12px] py-[10px] rounded-[5px] hover:bg-[#515151]  cursor-pointer mb-[5px] box-border" onClick={() => setProductCategory(!productCategory)}>
          <span className="icon">
          ...
          ("") : 
          (<ul className="w-[230px] ">
            <Link to="/dashboard/products/add-p-category">
              <li className="w-full grid grid-cols-[20%_auto] hover:bg-[#515151]  rounded-[5px] my-[5px] p-[10px]">
                <FaRegCircle className="text-[#ffffff6a] w-full mt-[5px] p-1 text-[14px]" />
        ...
        <li className="w-full grid grid-cols-[20%_auto_10%] px-[12px] py-[10px] rounded-[5px] hover:bg-[#515151]  cursor-pointer mb-[5px] box-border" onClick={() => setProduct(!product)}>
          <span className="icon">
      ...
      <div className="flex justify-end border-up box-border footer" onClick={handleLogOut}>
        
          <span className="block p-[12px_0] text-white" >
